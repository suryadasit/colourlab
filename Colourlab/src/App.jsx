...
export default function App() {
  ...
  // ✅ Apply dark mode globally to <html>
  useEffect(() => {
    if (darkMode) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
      {/* Header */}
      <header className="p-4 bg-white dark:bg-gray-900 shadow flex justify-between items-center fixed top-0 left-0 right-0 z-50">
